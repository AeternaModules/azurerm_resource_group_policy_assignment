output "resource_group_policy_assignments" {
  ...
  value       = azurerm_resource_group_policy_assignment.resource_group_policy_assignments
}
output "resource_group_policy_assignments_description" {
  ...
  value       = [for k, v in azurerm_resource_group_policy_assignment.resource_group_policy_assignments : v.description]
}
output "resource_group_policy_assignments_display_name" {
  ...
  value       = [for k, v in azurerm_resource_group_policy_assignment.resource_group_policy_assignments : v.display_name]
}
output "resource_group_policy_assignments_enforce" {
  ...
  value       = [for k, v in azurerm_resource_group_policy_assignment.resource_group_policy_assignments : v.enforce]
}
output "resource_group_policy_assignments_identity" {
  ...
  value       = [for k, v in azurerm_resource_group_policy_assignment.resource_group_policy_assignments : v.identity]
}
output "resource_group_policy_assignments_location" {
  ...
  value       = [for k, v in azurerm_resource_group_policy_assignment.resource_group_policy_assignments : v.location]
}
output "resource_group_policy_assignments_metadata" {
  ...
  value       = [for k, v in azurerm_resource_group_policy_assignment.resource_group_policy_assignments : v.metadata]
}
output "resource_group_policy_assignments_name" {
  ...
  value       = [for k, v in azurerm_resource_group_policy_assignment.resource_group_policy_assignments : v.name]
}
output "resource_group_policy_assignments_non_compliance_message" {
  ...
  value       = [for k, v in azurerm_resource_group_policy_assignment.resource_group_policy_assignments : v.non_compliance_message]
}
output "resource_group_policy_assignments_not_scopes" {
  ...
  value       = [for k, v in azurerm_resource_group_policy_assignment.resource_group_policy_assignments : v.not_scopes]
}
output "resource_group_policy_assignments_overrides" {
  ...
  value       = [for k, v in azurerm_resource_group_policy_assignment.resource_group_policy_assignments : v.overrides]
}
output "resource_group_policy_assignments_parameters" {
  ...
  value       = [for k, v in azurerm_resource_group_policy_assignment.resource_group_policy_assignments : v.parameters]
}
output "resource_group_policy_assignments_policy_definition_id" {
  ...
  value       = [for k, v in azurerm_resource_group_policy_assignment.resource_group_policy_assignments : v.policy_definition_id]
}
output "resource_group_policy_assignments_resource_group_id" {
  ...
  value       = [for k, v in azurerm_resource_group_policy_assignment.resource_group_policy_assignments : v.resource_group_id]
}
output "resource_group_policy_assignments_resource_selectors" {
  ...
  value       = [for k, v in azurerm_resource_group_policy_assignment.resource_group_policy_assignments : v.resource_selectors]
}
