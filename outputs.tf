output "resource_group_policy_assignments_id" {
  ...
  value       = { for k, v in azurerm_resource_group_policy_assignment.resource_group_policy_assignments : k => v.id if v.id != null && length(v.id) > 0 }
}
output "resource_group_policy_assignments_description" {
  ...
  value       = { for k, v in azurerm_resource_group_policy_assignment.resource_group_policy_assignments : k => v.description if v.description != null && length(v.description) > 0 }
}
output "resource_group_policy_assignments_display_name" {
  ...
  value       = { for k, v in azurerm_resource_group_policy_assignment.resource_group_policy_assignments : k => v.display_name if v.display_name != null && length(v.display_name) > 0 }
}
output "resource_group_policy_assignments_enforce" {
  ...
  value       = { for k, v in azurerm_resource_group_policy_assignment.resource_group_policy_assignments : k => v.enforce if v.enforce != null }
}
output "resource_group_policy_assignments_identity" {
  ...
  value       = { for k, v in azurerm_resource_group_policy_assignment.resource_group_policy_assignments : k => one(v.identity) if v.identity != null && length(v.identity) > 0 }
}
output "resource_group_policy_assignments_location" {
  ...
  value       = { for k, v in azurerm_resource_group_policy_assignment.resource_group_policy_assignments : k => v.location if v.location != null && length(v.location) > 0 }
}
output "resource_group_policy_assignments_metadata" {
  ...
  value       = { for k, v in azurerm_resource_group_policy_assignment.resource_group_policy_assignments : k => v.metadata if v.metadata != null && length(v.metadata) > 0 }
}
output "resource_group_policy_assignments_name" {
  ...
  value       = { for k, v in azurerm_resource_group_policy_assignment.resource_group_policy_assignments : k => v.name if v.name != null && length(v.name) > 0 }
}
output "resource_group_policy_assignments_non_compliance_message" {
  ...
  value       = { for k, v in azurerm_resource_group_policy_assignment.resource_group_policy_assignments : k => v.non_compliance_message if v.non_compliance_message != null && length(v.non_compliance_message) > 0 }
}
output "resource_group_policy_assignments_not_scopes" {
  ...
  value       = { for k, v in azurerm_resource_group_policy_assignment.resource_group_policy_assignments : k => v.not_scopes if v.not_scopes != null && length(v.not_scopes) > 0 }
}
output "resource_group_policy_assignments_overrides" {
  ...
  value       = { for k, v in azurerm_resource_group_policy_assignment.resource_group_policy_assignments : k => v.overrides if v.overrides != null && length(v.overrides) > 0 }
}
output "resource_group_policy_assignments_parameters" {
  ...
  value       = { for k, v in azurerm_resource_group_policy_assignment.resource_group_policy_assignments : k => v.parameters if v.parameters != null && length(v.parameters) > 0 }
}
output "resource_group_policy_assignments_policy_definition_id" {
  ...
  value       = { for k, v in azurerm_resource_group_policy_assignment.resource_group_policy_assignments : k => v.policy_definition_id if v.policy_definition_id != null && length(v.policy_definition_id) > 0 }
}
output "resource_group_policy_assignments_resource_group_id" {
  ...
  value       = { for k, v in azurerm_resource_group_policy_assignment.resource_group_policy_assignments : k => v.resource_group_id if v.resource_group_id != null && length(v.resource_group_id) > 0 }
}
output "resource_group_policy_assignments_resource_selectors" {
  ...
  value       = { for k, v in azurerm_resource_group_policy_assignment.resource_group_policy_assignments : k => v.resource_selectors if v.resource_selectors != null && length(v.resource_selectors) > 0 }
}
